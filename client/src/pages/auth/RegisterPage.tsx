    ...
    <div className="max-w-5xl min-h-[70vh] mx-auto">
      <div className=" w-full mt-14">
        <motion.h1
          ...
          className="text-primary text-xl font-bold text-center"
        >
          Create Your Account
        </motion.h1>
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.3, delay: 0 }}
          className="sm:w-1/2 mx-4  sm:mx-auto mt-10 bg-white/20 drop-shadow-md py-14 px-8 sm:px-4 rounded-lg"
        >
          <form
          ...
          >
            ...
            <button
              type="submit"
              className="btn btn-info text-primary flex items-center gap-x-
            3 uppercase"
          ...
          <div className="flex items-center md:gap-2 gap-x-1 py-4 mx-auto justify-center">
